...
public class WerewolfModel extends ModelBase {
	...
	public WerewolfModel() {
		...
		this.setRotateAngle(torso1, 0.19198621771937624F, 0.0F, 0.0F);
		...
		this.arm2.setRotationPoint(5.0F, -3.0F, -0.5F);
		this.arm2.addBox(0.0F, -2.0F, -2.0F, 4, 16, 4, 0.0F);
		this.setRotateAngle(arm2, -0.19198621771937624F, 0.0F, 0.0F);
		this.feet2 = new ModelRenderer(this, 36, 36);
		this.feet2.setRotationPoint(0.0F, 3.0F, 0.0F);
		this.feet2.addBox(-2.0F, 0.0F, -2.5F, 4, 3, 5, 0.0F);
		this.setRotateAngle(feet2, -0.13962634015954636F, 0.0F, 0.0F);
		...
		this.leg2.setRotationPoint(2.0F, 7.5F, 0.0F);
		this.leg2.addBox(-2.0F, -0.5F, -2.0F, 4, 8, 4, 0.0F);
		this.setRotateAngle(leg2, -0.3490658503988659F, 0.0F, 0.0F);
		this.leg4 = new ModelRenderer(this, 24, 32);
		this.leg4.setRotationPoint(0.0F, 7.0F, 0.0F);
		this.leg4.addBox(-1.5F, 0.0F, -1.5F, 3, 5, 3, 0.0F);
		this.setRotateAngle(leg4, 0.296705972839036F, 0.0F, 0.0F);
		this.arm1 = new ModelRenderer(this, 38, 0);
		this.arm1.setRotationPoint(-5.0F, -3.0F, -0.5F);
		this.arm1.addBox(-4.0F, -2.0F, -2.0F, 4, 16, 4, 0.0F);
		this.setRotateAngle(arm1, -0.19198621771937624F, 0.0F, 0.0F);
		this.leg1 = new ModelRenderer(this, 38, 24);
		this.leg1.setRotationPoint(-2.0F, 7.5F, 0.0F);
		this.leg1.addBox(-2.0F, -0.5F, -2.0F, 4, 8, 4, 0.0F);
		this.setRotateAngle(leg1, -0.3490658503988659F, 0.0F, 0.0F);
		this.leg3 = new ModelRenderer(this, 24, 32);
		this.leg3.setRotationPoint(0.0F, 7.0F, 0.0F);
		this.leg3.addBox(-1.5F, 0.0F, -1.5F, 3, 5, 3, 0.0F);
		this.setRotateAngle(leg3, 0.296705972839036F, 0.0F, 0.0F);
		this.ear2 = new ModelRenderer(this, 0, 0);
		this.ear2.setRotationPoint(3.0F, -8.0F, -1.0F);
		this.ear2.addBox(-1.0F, -2.0F, 0.0F, 2, 2, 1, 0.0F);
		this.feet1 = new ModelRenderer(this, 36, 36);
		this.feet1.mirror = true;
		this.feet1.setRotationPoint(0.0F, 3.0F, 0.0F);
		this.feet1.addBox(-2.0F, 0.0F, -2.5F, 4, 3, 5, 0.0F);
		this.setRotateAngle(feet1, -0.13962634015954636F, 0.0F, 0.0F);
		this.head.addChild(this.ear1);
		this.chest.addChild(this.arm2);
		this.leg4.addChild(this.feet2);
		this.torso1.addChild(this.tail);
		this.chest.addChild(this.head);
		this.torso1.addChild(this.chest);
		this.head.addChild(this.snout);
		this.torso1.addChild(this.leg2);
		this.leg1.addChild(this.leg4);
		this.chest.addChild(this.arm1);
		this.torso1.addChild(this.leg1);
		this.leg2.addChild(this.leg3);
		this.head.addChild(this.ear2);
		this.leg3.addChild(this.feet1);
	}
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.leg1.rotateAngleX = -0.139F + MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount / f;
		this.leg2.rotateAngleX = -0.139F + MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount / f;
