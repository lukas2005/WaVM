...
import com.aguila.wavm.render.entity.RenderPlayerWerewolf;
...
public class WerewolfEventhandler {
	...
	private static RenderPlayerWerewolf wereRender = null;
	...
	public static void renderPlayer(RenderPlayerEvent.Pre e) {
		...
		if (were.getIsTransformed() && Minecraft.getMinecraft().getRenderViewEntity() == e.getEntityPlayer()) {
			e.setCanceled(true);
			if (wereRender == null)
				wereRender = new RenderPlayerWerewolf(Minecraft.getMinecraft().getRenderManager());
	...
	public static void onJoin(EntityJoinWorldEvent e) {
		...
		if (!e.getWorld().isRemote && e.getEntity() instanceof EntityVillager
			...
			EntityWerewolf werewolf = new EntityWerewolf(e.getWorld());
